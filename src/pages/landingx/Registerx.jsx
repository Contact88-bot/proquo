...
function Registerx() {
  ...
  const register = (e) => {
    ...
    fetch("https://api.proquoauctions.com/sign-up", {
      method: "post",
  ...
  return (
    <div className="flex flex-col bg-[#26313f3a] shadow-md rounded text-slate-700 items-center px-3 justify-center pt-3 w-full">
